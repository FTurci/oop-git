...
The only missing program is the Github command line utility `gh`. This allows you to interact with Github and modify repote git repository. This is ultimately optional. 
...
```
This fetches to the noteable home folder a compressed package `gh_2.60.1_linux_amd64.tar.gz`. To decompress it type
