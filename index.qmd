...
The only missing program is the Github command line utility `gh`. This allows you to interact with Github and modify a remote git repository. This is ultimately optional. 
