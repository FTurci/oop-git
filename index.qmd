...
The only missing program is the Github command line utility `gh`. To install it, we simply fetch a precompiled version. Type the following in the Noteable terminal 
